...
def saveNetwork(words, edges):
        out = codecs.open("network/minused.net","w", "utf-8-sig")
        out2 = codecs.open("network/minused.vertices","w", "utf-8-sig")
        out3 = codecs.open("network/minused.edges","w", "utf-8-sig")
